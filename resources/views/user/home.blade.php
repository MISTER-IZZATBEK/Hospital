        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-8 text-sm">
                    <div class="site-info">
                        <a href="#"><span class="mai-call text-primary"></span> +998 33 919 98 08</a>
                        <span class="divider">|</span>
                        <a href="#"><span class="mai-mail text-primary"></span> jumaniyazovizzatbek98@gmail.com</a>
                    </div>
                </div>
            ...
            <form action="{{url('search')}}" method="get">
                <div class="input-group input-navbar">
                    <div class="input-group-prepend">
                        <button class="input-group-text " type="submit" value="Search"  id="icon-addon1"><span class="mai-search"></span></button>
                    </div>
            ...
            <div class="collapse navbar-collapse" id="navbarSupport">
                <ul class="navbar-nav ml-auto">
                    ...
                    @if(Route::has('login'))
                        ...
                        @else
                    <li class="nav-item">
                        <a class="btn btn-primary ml-lg-3 m-2" href="{{route('login')}}">Login</a>
                    </li>
                    <li class="nav-item">
